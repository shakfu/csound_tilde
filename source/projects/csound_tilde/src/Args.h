...
public:
	...
	void SetCsoundArguments(short argc, const t_atom *argv, const std::string & path, const std::string & defaultPath);
	...
	inline const std::string & CsdPath() { return m_csdPath; }
	inline const std::string & OrcPath() { return m_orcPath; }
	inline const std::string & ScoPath() { return m_scoPath; }
...
private:
	...
	std::string m_orcPath;       // Path to orchestra file.
	std::string m_scoPath;       // Path to score file.
	std::string m_csdPath;       // Path to csd file.
};
